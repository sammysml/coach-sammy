...
const PLAN = [
  { category: 'main_meals', meal_type: 'lunch',     count: 35, kind: 'high-protein savory main meal or bowl' },
  { category: 'Breakfasts', meal_type: 'breakfast', count: 16, kind: 'high-protein anabolic breakfast' },
  { category: 'Desserts',   meal_type: 'dessert',   count: 16, kind: 'high-protein anabolic dessert or protein treat' },
  { category: 'snacks',     meal_type: 'snack',     count: 16, kind: 'high-protein anabolic snack' },
  { category: 'Fast Food Remakes', meal_type: 'lunch', count: 17, kind: 'anabolic fast-food remake (burger, pizza, fried chicken, wrap, etc.) made lean and high-protein' },
];
